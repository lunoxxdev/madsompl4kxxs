...
data_ip="https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/Pejuhhhhh"
checking_sc() {
...
Exp=$(curl -sS https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/Pejuhhhhh | grep $MYIP | awk '{print $3}')
fi
